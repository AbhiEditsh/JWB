...
exports.removeFromWishlist = async (req, res) => {
  try {
    ...
    console.log("Received request to remove from wishlist:", { userId, productId });
    ...
    console.log("Wishlist before removing item:", wishlist);
...
exports.getWishlist = async (req, res) => {
  try {
    ...
    const wishlist = await Wishlist.findOne({ userId }).populate("items.productId", "name price oldPrice ProductImage Available");
